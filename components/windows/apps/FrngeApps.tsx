  ...
  return (
    <section className="space-y-5 text-sm text-text">
      <header className="space-y-1 border-b border-border pb-4">
        <h2 className="font-identity text-xl tracking-[0.08em]">FRNGE</h2>
  ...
  return (
    <section className="space-y-4">
      <header className="border-b border-border pb-3">
        <h2 className="font-identity text-base tracking-[0.08em] text-text">RELEASES/</h2>
        <p className="mt-1 text-xs text-muted">FRNGE catalogue index</p>
      </header>
      <ol className="divide-y divide-border border-y border-border text-xs text-text">
...
export function ListenDirectory() {
  return (
    <section className="space-y-4">
      <header>
        <h2 className="font-identity text-base tracking-[0.08em] text-text">LISTEN.EXE</h2>
...
export function ContactMail() {
  ...
  return (
    <section className="space-y-4">
      <header className="border-b border-border pb-3">
        <h2 className="font-identity text-base tracking-[0.08em] text-text">CONTACT.MAIL</h2>
  ...
  return (
    <section className="space-y-4 text-sm">
      <div className="space-y-1">
        <h2 className="font-identity text-base tracking-[0.08em] text-text">CHAMBER/</h2>
